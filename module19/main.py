...
from module18.app import unique_titles
...
fig = px.bar(size, x='Year', y='Counts', color='Genre', title="Number of fiction vs non-fictional books from (2009-2022)", color='Genre',
...
fig = px.bar(top_authors , x='Count' , y='Authors' , orientation='h'),
